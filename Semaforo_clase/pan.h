...
#define PanSource	"Semaforos.pml"
...
#define _nstates4	34	/* p3 */
#define minseq4	136
#define maxseq4	168
#define _endstate4	33

#define _nstates3	50	/* p2 */
#define minseq3	87
#define maxseq3	135
#define _endstate3	49

#define _nstates2	11	/* p1 */
#define minseq2	77
#define maxseq2	86
...
#define _nstates0	68	/* fsm */
#define minseq0	0
#define maxseq0	66
#define _endstate0	67
...
#define HAS_TRACK	0
/* hidden variable: */	int Rp;
/* hidden variable: */	int Ap;
/* hidden variable: */	int Rs;
/* hidden variable: */	int As;
